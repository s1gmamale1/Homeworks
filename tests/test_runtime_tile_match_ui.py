...
def test_tm_panel_present():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-1", "subject": "math-algebra", "grade": 8})
...
def test_tm_topbar_has_dots_and_match_pill():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-2", "subject": "math-algebra", "grade": 8})
...
def test_tm_hero_has_eyebrow_title_subtitle_xp():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-3", "subject": "math-algebra", "grade": 8})
...
def test_tm_stats_grid_has_no_fake_timer():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-4", "subject": "math-algebra", "grade": 8})
...
def test_tm_board_columns():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-5", "subject": "math-algebra", "grade": 8})
...
def test_tm_result_card_present():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-6", "subject": "math-algebra", "grade": 8})
...
def test_tm_toast_present():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-7", "subject": "math-algebra", "grade": 8})
...
def test_tm_toast_is_fixed_to_bottom_feedback_area():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-7B", "subject": "math-algebra", "grade": 8})
...
def test_tm_state_slot_in_gbState(field):
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-8", "subject": "math-algebra", "grade": 8})
...
def test_tm_global_declaration():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-9", "subject": "math-algebra", "grade": 8})
...
def test_tm_registry_row_at_slot_2():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-10", "subject": "math-algebra", "grade": 8})
    assert re.search(
...
def test_tm_dispatch_branch_updated():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-11", "subject": "math-algebra", "grade": 8})
...
def test_tm_extract_student_work_uses_tm_state():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-12", "subject": "math-algebra", "grade": 8})
    extractor = re.search(
...
def test_tm_state_machine_functions_present(fn):
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-13", "subject": "math-algebra", "grade": 8})
...
def test_tm_check_pair_endpoint_contract():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-14", "subject": "math-algebra", "grade": 8})
    fn_match = re.search(
...
def test_tm_init_mints_session_id_before_first_check():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-14B", "subject": "math-algebra", "grade": 8})
...
def test_tm_i18n_keys_uz_ru_en(key):
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-15", "subject": "math-algebra", "grade": 8})
...
def test_tm_dark_mode_has_parity():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-16", "subject": "math-algebra", "grade": 8})
...
def test_tm_no_answer_leak_attrs_in_panel():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-17", "subject": "math-algebra", "grade": 8})
...
def test_tm_no_runtime_mode_toggle():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-18", "subject": "math-algebra", "grade": 8})
...
def test_tm_answer_leak_guard_at_js_layer():
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-19", "subject": "math-algebra", "grade": 8})
    forbidden = [
...
def test_tm_legacy_mm_classes_untouched(cls):
    ...
    html = _inject_full(_empty_content(), runtime_context={"hw_id": "HW-TM-20", "subject": "math-algebra", "grade": 8})
    assert cls in html, (
